    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label for="tcategory_id-field">Tcategory_id</label>
                    <input class="form-control" type="text" name="tcategory_id" id="tcategory_id-field" value="{{ old('tcategory_id', $topic->tcategory_id ) }}" />
                </div> 
                <div class="form-group">
